...
const ConsultingForm = () => {
  ...
  return (
    <form
      ...
      className="max-w-3xl mt-10 mx-auto bg-neutral-900 text-white p-8 rounded-2xl shadow-lg space-y-6"
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <input
          ...
          className="p-3 rounded-md bg-neutral-800 border border-neutral-700 focus:outline-none focus:ring-2 focus:ring-orange-500"
          required
        />
        <input
          type="text"
...
<option value="manufactura">Otros</option>
