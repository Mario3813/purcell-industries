...
const HeroSection = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-full overflow-x-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-4 sm:px-6 text-white">
          ...
          <div className="flex justify-center my-6 sm:my-10 gap-3 sm:gap-6 flex-nowrap">
            <HashLink
              smooth
              to="#servicios"
              className="bg-gradient-to-r from-orange-500 to-orange-800 py-2 sm:py-3 px-4 sm:px-6 rounded-md text-sm sm:text-base whitespace-nowrap hover:from-orange-600 hover:to-orange-900 transition-all duration-300 ease-in-out transform hover:scale-105"
            >
              Nuestros servicios
            </HashLink>
            ...
            <HashLink
              smooth
              to="#marcas"
              className="py-2 sm:py-3 px-4 sm:px-6 rounded-md border border-white text-sm sm:text-base whitespace-nowrap hover:bg-white hover:text-black transition-all duration-300 ease-in-out transform hover:scale-105 scroll-smooth"
            >
              Nuestros aliados
            </HashLink>
          </div>
      ...
      {/* CONTENIDO CENTRADO */}
      <div className="w-full max-w-7xl mx-auto mt-[80px] sm:mt-[100px] px-4 sm:px-6">
      ...
      <div
        id="Soluciones"
        className="w-full max-w-7xl mx-auto flex justify-center mt-10 px-4 sm:px-6"
      >
        <div className="flex gap-4 text-white text-sm sm:text-lg overflow-x-auto no-scrollbar whitespace-nowrap max-w-full">
          <button
            onClick={() => setActiveCategory("automatizacion")}
            className={`flex-shrink-0 transition-colors duration-500 ${
              activeCategory === "automatizacion" ? "text-orange-500" : "text-white"
            }`}
          >
            Automatización
          </button>
          ...
          <button
            ...
            className={`flex-shrink-0 transition-colors duration-500 ${
              activeCategory === "controles" ? "text-orange-500" : "text-white"
            }`}
          >
            Controles
          </button>
          ...
          <button
            ...
            className={`flex-shrink-0 transition-colors duration-500 ${
              activeCategory === "innovacion" ? "text-orange-500" : "text-white"
            }`}
          >
            Instrumentación
          </button>
      ...
      {/* IMÁGENES CENTRADAS */}
      <div className="mt-5 w-full max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex gap-6 overflow-x-auto no-scrollbar scroll-smooth max-w-full">
          {serviceImages[activeCategory].map((img, index) => (
            <img
              key={index}
              src={img}
              alt="service"
              className="flex-shrink-0 w-[85%] sm:w-[60%] md:w-[350px] lg:w-[400px] h-[250px] sm:h-[300px] md:h-[350px] lg:h-[450px] object-cover rounded-xl transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-orange-500/10"
            />
          ))}
        </div>
      </div>
